...
$english = array(
   ...
   'follow_tags:settings:minChar'			=> 'Min chars for autocomplete',
   'follow_tags:settings:threshold'			=> 'Tag threshold for autocomplete',
   'follow_tags:settings:defaultTags'		=> 'Default tags',
   'follow_tags:settings:tagLimit'			=> 'Total number of tags (0 for no limit)',
